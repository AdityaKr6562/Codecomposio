---
title: "Enhancing Action Inputs & Outputs 🛠️"
...
def tool_postprocessor(output_data): # Process output_data as needed
return processed_output_data

def action_preprocessor(input_data): # Modify input_data as needed
return modified_input_data

def action_postprocessor(output_data): # Process output_data as needed
return processed_output_data
...
<Warning>
  Ensure that your preprocessing and postprocessing functions are efficient and
  don't introduce significant latency.
</Warning>
